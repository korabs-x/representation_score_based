...
def get_default_configs():
    ...
    training.experiment_name = 'mnist_lambda_t1e-1'  # mnist_samext mnist_t1e-1 mnistsmall mnist_3d_reg0 mnist_2d_reg1e-5 mnist_128d_nondet_reg1e-5 mnist_10d_reg1e-5_norm05 mnist_latent_reg128_diffarc mnist_latent_noreg128_diffarc mnist_latent_noreg10_diffarc mnist_latent_noreg10 mnist mnist_latent
    ...
    model.lambda_z = None if not model.include_latent else (0. if model.deterministic_latent_input else 1e-7)
    model.single_t = 1e-1
